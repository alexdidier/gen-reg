classdef GenReg_PWB_constr_poly
    %GENREG_PWB_CONSTR_POLY Generalised dynamic regret controller for PWB
    %dist and constrained problems with polytopic disturbance bounds
    %   Class for solving the generalised dynamic regret problem for
    %   pointwise in time bounded polytopic disturbances with state and
    %   input constraints
    ...
    methods
        function obj = GenReg_PWB_constr_poly(sys, params, weight, solver)
