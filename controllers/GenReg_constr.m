classdef GenReg_constr
    %GENREG_constr Generalised dynamic regret controller with constraints
    %   Class for solving the generalised dynamic regret problem for
    %   bounded energy disturbances with state and input constraints
    ...
    methods
        function obj = GenReg_constr(sys, params, weight, solver)
            %GENREG_CONSTR Construct an instance of this class
