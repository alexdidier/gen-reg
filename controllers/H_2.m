classdef H_2
    %H_2 Optimal H_2 controller
    %   Class for solving the H_2 problem
    ...
    methods
        function obj = H_2(sys, params, solver)
            %H_2 Construct an instance of this class
            %   Construct H_2 Controller Class
            %%% Parse inputs %%%
            switch nargin
                case 2
                    solver = '';
