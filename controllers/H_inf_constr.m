classdef H_inf_constr
    %H_inf_constr Optimal H_inf controller with constraints
    ...
    methods
        function obj = H_inf_constr(sys, params, solver)
            %H_INF_CONSTR Construct an instance of this class
            %   Construct H_inf_constr Controller Class
