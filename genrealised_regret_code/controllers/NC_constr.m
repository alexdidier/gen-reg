...
classdef NC_constr
    %NC_CONSTR Optimal non-causal controller with constraints
    ...
    methods
        function obj = NC_constr(sys, params, solver)
            %NC_CONSTR Construct an instance of this class
            %   Construct NC_constr Class
            %%% Parse inputs %%%
            switch nargin
                case 2
                    solver = '';
